...
export default function ChatPanel({ messages, input, onInputChange, onSubmit, isLoading, onResetSession, showSidebar = false }: ChatPanelProps) {
  return (
    <div className="flex-1 flex flex-col bg-white h-screen" style={{ width: "-webkit-fill-available" }}>
      <div className="p-4 border-b border-gray-200 flex justify-between items-center" style={{ width: "-webkit-fill-available" }}>
